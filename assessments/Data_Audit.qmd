...
I, Huang Zhiwei, confirm that the work presented in this assessment is my own. Where information has been derived from other sources, I confirm that this has been indicated in the work.
...
The dataset includes 74,188 columns of Airbnb data within the city of London, with each column representing a rental property and each column containing 73 granular metrics, including information such as landlord name, latitude, and longitude coordinates. The data can be categorised into four broad categories: the spatial distribution of homes, the level of service provided by the host, the condition of the home's neighborhood, and the rental status of the home. This data allows for a macro analysis of Airbnb housing within the city, for example, answering questions such as which areas of the city have the highest density of Airbnb housing. In addition, it is possible to focus on the housing itself and explore the impact of the different attributes of the housing on its rental status.
